...
| 起始版本 | <Since v="1.5.0" /> | — | <Since v="1.5.0" /> |
...
[Gen 页](#错误叠加)读它。这些 schema 和请求协议从消费端的角度记在 [VSCode 与 Rider](/docs/tools/vscode)。
...
<Cards>
  ...
  <Card title="项目设置" href="/docs/settings/project" description="这些命令读写的十三项设置。" />
