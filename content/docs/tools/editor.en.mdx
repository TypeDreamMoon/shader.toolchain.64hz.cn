...
| Since | <Since v="1.5.0" /> | — | <Since v="1.5.0" /> |
...
back by the plugin — the [Gen page](#error-overlay) reads it. The schemas and the request protocol
...
<Cards>
  ...
  <Card title="Project Settings" href="/en/docs/settings/project" description="The thirteen settings these commands read and write." />
