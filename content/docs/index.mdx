...
| Function 内置函数 | VSCode 扩展 `1.4.9` 统一 HLSL intrinsic、GLSL 别名和 Unreal 纹理采样 helper metadata，用于补全、Hover、Signature Help、Inlay Hint、诊断和语义高亮。 |
...
| VSCode 语言核心 | 扩展 `1.4.x` 使用 scanner / parser / context / symbol / provider 模块重写语言服务。 |
